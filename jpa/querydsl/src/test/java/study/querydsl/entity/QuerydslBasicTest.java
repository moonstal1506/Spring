...
public class QuerydslBasicTest {
    ...
    void startQuerydsl() {
        Member findMember = queryFactory
                .select(member)
                .from(member)
                .where(member.username.eq("mem1"))//파라미터 바인딩 처리
                .fetchOne();
     ...
     * 1. 회원 나이 내림차순
     * 2. 회원 이름 오름차순
     * 단, 2에서 회원 이름 없으면 마지막 출력(null last)
     */
    @Test
    void sort() {
        ...
        Member mem6 = result.get(1);
        Member memNull = result.get(2);

        assertThat(mem5.getUsername()).isEqualTo("mem5");
        assertThat(mem6.getUsername()).isEqualTo("mem6");
    ...
    void join_on_filtering() {
        ...
        List<Tuple> result = queryFactory
                ...
                .on(team.name.eq("teamA"))//외부조인
//                .where(team.name.eq("teamA")) 내부조인
                .fetch();
...
//                .where(allEq(usernameCond,ageCond))
    ...
    void bulkUpdate() {
        ...
        for (Member member1 : result) {
            ...
            // em.flush(); em.clear(); 안하면 디비꺼 안가져오고 영속성꺼 가져옴
        }
    }
